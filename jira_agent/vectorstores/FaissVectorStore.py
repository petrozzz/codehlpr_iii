...
from vectorstores.docstore import AddableMixin, Docstore
from vectorstores.docstore import InMemoryDocstore
...
def _results_to_text_and_scores(results: Any) -> List[Tuple[Document, float]]:
    return [
        (text.page_content, score) for text, score in results]
...
class FAISS(VectorStore):
    ...
    def similarity_search_with_score_by_vector(
        ...
        **kwargs: Any,
        ...
        return _results_to_text_and_scores(docs[:k])
    ...
    def from_embeddings(
        ...
        **kwargs: Any,
        ...
        texts = []
        embeddings = []
        for text, emb in zip(*text_embeddings):
            texts.append(text)
